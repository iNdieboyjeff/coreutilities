...
public final class AndroidUtil {
	...
	public static boolean isKindleFire() {
		return android.os.Build.MANUFACTURER.equals("Amazon")
				&& (android.os.Build.MODEL.equals("Kindle Fire") || android.os.Build.MODEL.startsWith("KF")
						|| android.os.Build.MODEL.startsWith("AFT") || android.os.Build.MODEL.startsWith("SD4930UR"));
	}
	...
	public static boolean isNexusDevice() {
		Log.i("Android Device", android.os.Build.MODEL);
		if (android.os.Build.MODEL.toLowerCase().contains("nexus"))
			return true;
		return false;
	}
