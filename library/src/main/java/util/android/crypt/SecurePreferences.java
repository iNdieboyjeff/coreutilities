...
/**
 * <p>An implementation of a SharedPreferences object that is encrypted.</p>
 *
 * @author Jeff Sutton
 */
public class SecurePreferences {
     ...
     *                       Hardcoding your key in the application is bad, but better than plaintext
     *                       preferences. Having the user enter the key upon application launch
     *                       is a safe(r) alternative, but annoying to the user.
     * @param encryptKeys    settings this to false will only encrypt the values,
     *                       true will encrypt both values and keys. Keys can contain a lot of
     *                       information about the plaintext value of the value which can be used
     *                       to decipher the value.
